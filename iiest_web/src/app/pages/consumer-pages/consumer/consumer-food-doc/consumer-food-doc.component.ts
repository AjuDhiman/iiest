...
export class ConsumerFoodDocComponent {
  ...
  wordFiles = [
    ...
    { name: 'Stock Monitoring Record', url: 'assets/pdf-assets/Stock Monitoring Record.docx', icon: 'assets/pdf-icon.png', type: 'word' },
    { name: 'Take AwayFood Inspection', url: 'assets/pdf-assets/Take AwayFood_Inspection.docx', icon: 'assets/pdf-icon.png', type: 'word' },
    { name: 'Thawing Temp.', url: 'assets/pdf-assets/Thawing Temp..docx', icon: 'assets/pdf-icon.png', type: 'word' }
  ];
